...
namespace CppCoverage
{
	...
	{
		explicit Line(const BreakPointInstruction& instructionToRestore,
		              void* dllBaseOfImage)
		...
		const BreakPointInstruction instructionToRestore_;
	...
	bool ExecutedAddressManager::RegisterAddress(
		...
		const BreakPointInstruction& instructionValue)
	{
	...
	//-------------------------------------------------------------------------
	boost::optional<BreakPointInstruction>
